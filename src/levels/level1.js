...
export const LEVEL_1 = {
  ...
  shapes: [
    ...
    { type: 'solid', nodes: [{x: 7184, y: 48}, {x: 8576, y: 48}, {x: 8576, y: 80}, {x: 7184, y: 80}] },
    { type: 'hazard', nodes: [{x: 8576, y: 80}, {x: 9664, y: 80}, {x: 9664, y: 96}, {x: 8576, y: 96}] },
    { type: 'ice', nodes: [{x: 9664, y: 48}, {x: 10032, y: 48}, {x: 10032, y: 80}, {x: 9664, y: 80}] },
    { type: 'solid', nodes: [{x: 9904, y: -384}, {x: 9936, y: -384}, {x: 9936, y: -16}, {x: 9904, y: -16}] },
    { type: 'solid', nodes: [{x: 10336, y: 128}, {x: 10576, y: 128}, {x: 10576, y: 160}, {x: 10336, y: 160}] },
    { type: 'solid', nodes: [{x: 10544, y: -352}, {x: 10576, y: -368}, {x: 10576, y: 128}, {x: 10544, y: 128}] },
    { type: 'solid', nodes: [{x: 9936, y: -384}, {x: 10576, y: -384}, {x: 10576, y: -352}, {x: 9936, y: -352}] },
    { type: 'hazard', nodes: [{x: 10432, y: 128}, {x: 10528, y: 128}, {x: 10528, y: 144}, {x: 10432, y: 144}] },
    { type: 'ice', nodes: [{x: 9088, y: 16}, {x: 9152, y: 16}, {x: 9152, y: 32}, {x: 9088, y: 32}] },
    { type: 'hazard', nodes: [{x: 10336, y: 128}, {x: 10368, y: 128}, {x: 10368, y: 144}, {x: 10336, y: 144}] },
    { type: 'solid', nodes: [{x: 9904, y: -96}, {x: 9936, y: -96}, {x: 9936, y: -64}, {x: 9904, y: -64}], channel: 'h', move: { dx: -32, dy: 0, duration: 0.5 } },
    { type: 'solid', nodes: [{x: 9904, y: -240}, {x: 9936, y: -240}, {x: 9936, y: -208}, {x: 9904, y: -208}], channel: 'h', move: { dx: -32, dy: 0, duration: 0.5 } },
    { type: 'bouncy', nodes: [{x: 10720, y: -320}, {x: 10912, y: -320}, {x: 10912, y: -304}, {x: 10720, y: -304}] },
    { type: 'bouncy', nodes: [{x: 11296, y: -304}, {x: 11440, y: -304}, {x: 11440, y: -288}, {x: 11296, y: -288}] },
    { type: 'bouncy', nodes: [{x: 11776, y: -368}, {x: 12000, y: -368}, {x: 12000, y: -352}, {x: 11776, y: -352}] },
    { type: 'bouncy', nodes: [{x: 12224, y: -528}, {x: 12432, y: -528}, {x: 12432, y: -512}, {x: 12224, y: -512}] },
    { type: 'bouncy', nodes: [{x: 12640, y: -832}, {x: 12864, y: -832}, {x: 12864, y: -816}, {x: 12640, y: -816}] },
    { type: 'bouncy', nodes: [{x: 13040, y: -1152}, {x: 13280, y: -1152}, {x: 13280, y: -1136}, {x: 13040, y: -1136}] },
    { type: 'solid', nodes: [{x: 14656, y: -1152}, {x: 15616, y: -1152}, {x: 15616, y: -1136}, {x: 14656, y: -1136}] },
    { type: 'solid', nodes: [{x: 14864, y: -1280}, {x: 14880, y: -1280}, {x: 14880, y: -1152}, {x: 14864, y: -1152}] },
    { type: 'solid', nodes: [{x: 14656, y: -1248}, {x: 14672, y: -1248}, {x: 14672, y: -1152}, {x: 14656, y: -1152}] },
  ],
  entities: [
    ...
    { type: 'ball', x: 7328, y: 32 },
    { type: 'ball', x: 7296, y: 32 },
    { type: 'ball', x: 7360, y: 32 },
    { type: 'ball', x: 7392, y: 32 },
    { type: 'ball', x: 7424, y: 32 },
    { type: 'ball', x: 7312, y: 0 },
    { type: 'ball', x: 7344, y: 0 },
    { type: 'ball', x: 7376, y: 0 },
    { type: 'ball', x: 7408, y: 0 },
    { type: 'ball', x: 7328, y: -32 },
    { type: 'ball', x: 7360, y: -32 },
    { type: 'ball', x: 7392, y: -32 },
    { type: 'ball', x: 7376, y: -64 },
    { type: 'ball', x: 7344, y: -64 },
    { type: 'ball', x: 7360, y: -96 },
    { type: 'ball', x: 9792, y: -352 },
    { type: 'crate', x: 14960, y: -1168 },
    { type: 'crate', x: 15024, y: -1168 },
    { type: 'crate', x: 15104, y: -1168 },
    { type: 'crate', x: 14960, y: -1200 },
    { type: 'crate', x: 14960, y: -1232 },
    { type: 'crate', x: 14960, y: -1264 },
    { type: 'crate', x: 14944, y: -1296 },
    { type: 'crate', x: 14976, y: -1296 },
    { type: 'crate', x: 14928, y: -1328 },
    { type: 'crate', x: 14992, y: -1328 },
    { type: 'crate', x: 14912, y: -1360 },
    { type: 'crate', x: 15008, y: -1360 },
    { type: 'crate', x: 15040, y: -1200 },
    { type: 'crate', x: 15088, y: -1200 },
    { type: 'crate', x: 15056, y: -1232 },
    { type: 'crate', x: 15088, y: -1232 },
    { type: 'crate', x: 15072, y: -1264 },
    { type: 'crate', x: 15168, y: -1264 },
    { type: 'crate', x: 15168, y: -1232 },
    { type: 'crate', x: 15168, y: -1200 },
    { type: 'crate', x: 15168, y: -1168 },
    { type: 'crate', x: 15152, y: -1296 },
    { type: 'crate', x: 15184, y: -1296 },
    { type: 'crate', x: 15136, y: -1328 },
    { type: 'crate', x: 15200, y: -1328 },
    { type: 'crate', x: 15120, y: -1360 },
    { type: 'crate', x: 15216, y: -1360 },
  ],
  switches: [
    ...
    { x: 10400, y: 128, w: 48, h: 10, channel: 'h', accepts: 'ball' },
    { x: 14768, y: -1152, w: 48, h: 10, channel: 'a', accepts: 'any' },
  ],
  tubes: [
    ...
    { radius: 22, wall: 7, nodes: [{x: 9904, y: 16}, {x: 10208, y: 16}, {x: 10208, y: 112}, {x: 9904, y: 112}, {x: 9904, y: 192}, {x: 10304, y: 192}, {x: 10304, y: -48}, {x: 10400, y: -48}, {x: 10400, y: 16}] },
    { radius: 22, wall: 7, nodes: [{x: 13168, y: -1616}, {x: 13168, y: -1920}, {x: 13760, y: -1920}, {x: 14736, y: -1232}] },
  ],
  checkpoints: [
    { x: 3440, y: 640, w: 16, h: 46 },
    { x: 4448, y: 160, w: 16, h: 46 },
    { x: 8560, y: 48, w: 16, h: 46 },
    { x: 9792, y: 48, w: 16, h: 46 },
    { x: 10544, y: -384, w: 16, h: 46 },
  ],
};
